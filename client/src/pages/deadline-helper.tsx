          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-6 bg-primary/10 rounded-lg p-6 text-center">
                <h3 className="text-lg font-medium mb-3">Ready to create your comprehensive comic book schedule?</h3>
                <Button 
                  className="px-6" 
    ...
    <>
      ...
      <div className="container max-w-6xl py-8">
        ...
        <div className="mt-16 text-center border-t pt-8">
          <h2 className="text-2xl font-bold mb-2">Marketing Deadline Helper</h2>
