          ...
          <div>
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <Label htmlFor="forward" className="text-base font-medium">Calculate in-store date from completion date</Label>
                  <p className="text-sm text-muted-foreground">I know when my comic will be completed and want to know when it can be in stores</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <RadioGroupItem value={CalculationDirection.BACKWARD} id="backward" />
                <div>
                  <Label htmlFor="backward" className="text-base font-medium">Calculate completion deadline from in-store date</Label>
                  <p className="text-sm text-muted-foreground">I have a target in-store date and need to know when my comic must be completed</p>
                </div>
              </div>
            </RadioGroup>
          </div>
